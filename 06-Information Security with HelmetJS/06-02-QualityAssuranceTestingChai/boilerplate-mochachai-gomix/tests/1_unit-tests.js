...
suite('Unit Tests', function(){
  ...
  suite('Equality', function() {
    ...
    test('#strictEqual, #notStrictEqual', function(){
      assert.notStrictEqual( 6, '6', "Don/'t forget you can add in your own custom error message here" );
...
// -----------------------------------------------------------------------------
  ...
  suite('Comparisons', function() {
    ...
    test('#isAbove, #isAtMost', function() {
      assert.isAtMost('hello'.length , 5, ' Notice what order the data comes in ');
      assert.isAbove(1, 0);
    ...
    test('#approximately', function() {
      assert.approximately(weirdNumbers(0.5) , 1, 0.5 , "This is the optional message");
      assert.approximately(weirdNumbers(0.2) , 1, 0.8, "still trying to figure out why this passes" );
    });
  });
